...
|---|---|
| The clock reaches its next deadline and calls [`tick`](../../terminalgame/presentation/view_model.py#L291) | Returns at once. The ghost does not move, the count of ticks does not go up, and no picture is built |
| A player presses an arrow and the loop calls [`on_direction`](../../terminalgame/presentation/view_model.py#L310) | Returns at once. No move, no pill, no score |
...
|---|---|
| [`GameViewModel`](../../terminalgame/presentation/view_model.py#L227) | In this scenario it is the **referee**: [`_take_pill`](../../terminalgame/presentation/view_model.py#L340) counts the pills down, [`on_direction`](../../terminalgame/presentation/view_model.py#L310) notices the count has reached nothing, and [`_status_line`](../../terminalgame/presentation/view_model.py#L415) writes a different line from then on |
...
| 2 | [`on_direction`](../../terminalgame/presentation/view_model.py#L310)`(1, 0)` | The same call as every other move |
...
| 6 | [`emit`](../../terminalgame/util/flow.py#L56)`(a picture whose readings line says CLEARED)` | The line of readings is built fresh for every picture, and from now on [it takes the other branch](../../terminalgame/presentation/view_model.py#L438): the score, the word `CLEARED`, and a reminder of the key that quits |
...
[^viewmodel]: The **view model** is the part of the program that keeps track of
    ...
    [`GameViewModel`](../../terminalgame/presentation/view_model.py#L227). It holds
