...
| [`GameViewModel`](../../terminalgame/presentation/view_model.py#L227) | Everything the game knows about where things are. In this scenario it is the **mover**: [`on_direction`](../../terminalgame/presentation/view_model.py#L310) applies the step, keeps the result inside the walls, and builds an entirely new picture. It is told a direction and never learns what caused it |
