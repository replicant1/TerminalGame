...
|---|---|
| [`main`](../../terminalgame/app/main.py) | The way into the program. This is a module of plain functions rather than a class. In this scenario it is the **doorman**: [`_parse_arguments`](../../terminalgame/app/main.py#L121) works out which of the two copies this one is, and [`main`](../../terminalgame/app/main.py#L148) then sends it either to open a window or to play the game |
