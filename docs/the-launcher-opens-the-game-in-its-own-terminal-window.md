...
[`launch`](../terminalgame/app/launcher.py#L148) refuses outright, straight
...
|---|---|
| [`main`](../terminalgame/app/main.py) | The way into the program. This is a module of plain functions rather than a class. In this scenario it is the **doorman**: [`parse_arguments`](../terminalgame/app/main.py#L97) works out which of the two copies this one is, and [`main`](../terminalgame/app/main.py#L115) then sends it either to open a window or to play the game |
...
- **A quit key ends the game and closes the window** — the other half of the
...
[^environment]: The **environment** is a small set of named values that every
    ...
    them, [`ENV_CHILD`](../terminalgame/app/launcher.py#L49) and
    [`ENV_SENTINEL`](../terminalgame/app/launcher.py#L50).
