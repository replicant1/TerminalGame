...
[`launch`](../terminalgame/app/launcher.py#L131) refuses outright, straight
...
[^environment]: The **environment** is a small set of named values that every
    ...
    them, [`TERMINALGAME_CHILD`](../terminalgame/app/launcher.py#L36) and
    [`TERMINALGAME_SENTINEL`](../terminalgame/app/launcher.py#L37).
